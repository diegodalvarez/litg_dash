...
def diagnostics():
    ...
    try:
        ...
        try:
            ...
            test = pd.read_csv("holdings.xlsx")
            st.subheader("file is an xlsx, due to the file output from the brokerage service we can only accept xls")
        
        except:
            st.subheader("tried finding xlsx please read documentation for excel file")
